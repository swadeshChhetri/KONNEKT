...
export default function BusinessProductDetails({ params }) {
  ...
  const handleBuyNow = () => {
    router.push(`/checkout?quantity=${count}`); // Navigate to checkout with quantity
  };
    ...
    <div className="container mx-auto p-4 grid grid-cols-1 md:grid-cols-3 gap-6 pt-24">
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-3 mt-4">
          ...
          <button className="btn btn-primary flex items-center" onClick={handleBuyNow}>

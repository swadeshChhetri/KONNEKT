...
export default async function ConsumerProductDetails({params}) {
    ...
    <div className="container mx-auto px-4 py-8 grid md:grid-cols-2 gap-8 pt-32">
      ...
      <div>
        ...
        <div className="mt-6 flex gap-4">
          ...
          <button className="bg-orange-600 text-white px-6 py-3 w-1/2 rounded-lg text-lg font-semibold shadow-md inline-flex items-center justify-center gap-2">
            <ShoppingBag size={20} />
            <span>BUY NOW</span>
          </button>
        </div>
